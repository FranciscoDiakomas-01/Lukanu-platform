    ...
    <main className="w-full  ">
      ...
      <Tabs defaultValue="profile" className=" w-full px-6 ">
        ...
        <TabsContent value="finance" className="space-y-6">
          <h2 className="text-lg font-semibold">Dados para Saque</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              <Label htmlFor="iban">IBAN</Label>
              <Input id="iban" placeholder="Ex: AO06 1234 5678 9012" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="bank">Banco</Label>
              <Input id="bank" placeholder="Nome do banco (ex: BAI)" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="currency">Moeda preferida</Label>
              <Input id="currency" placeholder="KZ / USD / EUR" />
            </div>
          </div>
          <Button className="mt-4">Atualizar Dados Bancários</Button>
        </TabsContent>
